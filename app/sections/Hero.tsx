...
export default function Hero () {
    return(
        <div className="w-full h-full">
            <div className=" absolute z-10 w-full h-full items-start justify-center flex">
                <div className="w-full border border-amber-200 sm:flex xl:w-7xl xl:pt-20">
                ...
                <div className="absolute z-20  bottom-0 p-5 pt-10 lg: text-black bg-white w-full items-start justify-center flex" style={{
